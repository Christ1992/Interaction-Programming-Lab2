...
function reduceNumber(){numberOfGuests=numberOfGuests-1; SideNavView($("#sideNavView"), model);}
function plusNumber(){numberOfGuests =numberOfGuests+1;	SideNavView($("#sideNavView"), model); }
